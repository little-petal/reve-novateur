...
export const Header = () => {
  ...
  const navStyles = open ? "p-6 bg-black/70 text-7xl text-white absolute h-screen top-0 right-0 lg:block" : "hidden lg:flex lg:text-5xl";
      ...
      <div className="flex w-[100%] justify-between m-auto p-[5px]">
        ...
        <div className="flex basis-1/2 items-center justify-end p-[10px] font-league">
          <nav className={navStyles}>
            <ul className="flex flex-col lg:flex-row gap-[40px] lg:gap-[20px] lg:space-x-6 mt-32 lg:mt-0">
              <li>
