...
export default function Home() {
  ...
  return (
    <main className='static'>
      ...
      <section id="nav-skills" className="h-fit min-h-screen flex flex-col bg-bluegray snap-always">
      ...
      {/* Réalisations */}
      <section id="nav-projects" className="h-screen flex flex-col bg-bluegray relative snap-always ">
      ...
      {/* Contact */}
      <section id="nav-contact" className="h-screen flex flex-col bg-bluegray snap-always">
        <div className="h-24"></div>
